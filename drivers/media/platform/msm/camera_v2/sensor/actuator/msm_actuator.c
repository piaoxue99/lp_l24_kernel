...
static int32_t msm_actuator_park_lens(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	while (next_lens_pos) {
		...
		else
		{
			...
			{
				next_lens_pos = next_lens_pos - (min_code_per_step * 5);
			}
			else if (next_lens_pos >= 300)
			{
				next_lens_pos = next_lens_pos - (min_code_per_step * 4);
			}
			else if (next_lens_pos >= 200)
			{
				next_lens_pos = next_lens_pos - (min_code_per_step * 3);
			}
			else if (next_lens_pos >= 100)
			{
				next_lens_pos = next_lens_pos - (min_code_per_step * 2);
			}
			else
			{
				next_lens_pos = (next_lens_pos > min_code_per_step) ?
