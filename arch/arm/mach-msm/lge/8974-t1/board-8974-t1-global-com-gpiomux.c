...
#ifdef CONFIG_MACH_MSM8974_T1_GLOBAL_COM
// Resreved Pin
#define MSM8974_GPIO_END 146

static int gpio_reserved_pin[] = {
...
#endif /* CONFIG_MACH_MSM8974_T1_GLOBAL_COM */
...
#ifndef CONFIG_MACH_MSM8974_T1_GLOBAL_COM
...
#else /* CONFIG_MACH_MSM8974_T1_GLOBAL_COM */
...
static struct gpiomux_setting sensor_en_active_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting sensor_en_suspend_config = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};
...
static struct msm_gpiomux_config sensor_configs[] __initdata = {
	...
	},
	{
		.gpio	   = 121,		/* CAP_SAR_EN */
		.settings = {
			[GPIOMUX_ACTIVE]	= &sensor_en_active_config,
			[GPIOMUX_SUSPENDED] = &sensor_en_suspend_config,
		},
	},
	{
...
void __init msm_8974_init_gpiomux(void)
{
	...
	switch( revision ) {
		case HW_REV_EVB1:
			for ( gpio_index = 0 ; gpio_reserved_pin[gpio_index] < MSM8974_GPIO_END ; gpio_index++ ) {
				gpio_func_reserved_pin_config.gpio = gpio_reserved_pin[gpio_index];
...
#elif defined(CONFIG_MACH_MSM8974_T1_GLOBAL_COM)
	msm_gpiomux_install(msm_fuel_gauge_configs,
			ARRAY_SIZE(msm_fuel_gauge_configs));
#endif
#endif
